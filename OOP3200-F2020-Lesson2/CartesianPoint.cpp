...
CartesianPoint CartesianPoint::operator+(const CartesianPoint& other_point) const
{
	CartesianPoint tempPoint;
	tempPoint.SetX((*this).GetX() + other_point.GetX());
	tempPoint.SetY((*this).GetY() + other_point.GetY());
	
	return tempPoint;
}

CartesianPoint& CartesianPoint::operator=(const CartesianPoint& other_point)
{
	SetX(other_point.GetX());
	SetY(other_point.GetY());
	return *this;
}
